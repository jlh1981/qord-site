...
const nodes = [
  ...
  { id: 10, entry: 16, cat: 'Evolution', phase: 'Thread', x: 0.51, title: 'The "lying in bed" insight', summary: 'Everyone has caught themselves mid-thought and retraced the chain, each thought leading to the next through felt connection. The path was real but frays the moment you stop holding it. Qord is that, made intentional and made to survive the crossing.', reasoning: 'Gave everyone an immediate felt experience of the concept. No jargon needed. You already do this every night. Qord says: do it on purpose, across every boundary.', connections: 'One of two key manifesto metaphors alongside the studio story. Flagged as keynote opening. Universal, felt, no jargon required.', sig: 'H' },
      ...
      <Window title="qord.visualizer" id="visualizer">
        ...
        {selected && view==='qord' && <>
          ...
          <div className="exp-chat">
            ...
            {chatMessages.length > 0 && <div className="exp-chat-messages" ref={chatContainerRef}>
